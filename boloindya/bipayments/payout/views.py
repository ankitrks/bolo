...
from bipayments.partner.models import Beneficiary
from bipayments.payout.models import ScheduledPayment, Transaction
from bipayments.payout.serializers import ScheduledPaymentSerializer, TransactionSerializer, PaySerializer


class PaymentStatusView(TemplateView):
    template_name = "payout/payment/index.html"



class ScheduledPaymentView(TemplateView):
    template_name = "payout/scheduled_payment/index.html"
...
class TransactionView(TemplateView):
    template_name = "payout/transaction/index.html"
