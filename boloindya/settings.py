...
EMAIL_PORT = 587
INVOICE_EMAIL_HOST_USER = 'invoices@boloindya.com'
INVOICE_EMAIL_HOST_PASSWORD = '!nvo!ce$@3011&'
...
MIN_REC_TO_CACHE = REST_FRAMEWORK['PAGE_SIZE'] * 1
TRENDING_CACHE_TIMESPAN = 7 # in days
CATEGORY_N_HASHTAG_CACHE_TIMESPAN = 7 # in days
DATE_TILL_CALCULATE = datetime.datetime(2019, 05, 01)
ALLOW_DUPLICATE_USER_POST = False

LAST_N_ACTIVE_DAYS = 3
TIME_DECAY_CONSTANT = 168 # 7 days in hours
