...
urlpatterns = [
    ...
    url(r'^old_algo_get_vb_list/$', OldAlgoVBList.as_view(), name='old_algo_get_vb_list'),
    ...
    url(r'^old_algo_get_category_detail_with_views/$', old_algo_get_category_detail_with_views),
    url(r'^get_category_video_bytes/$', get_category_video_bytes),
    url(r'^old_algo_get_category_video_bytes/$', old_algo_get_category_video_bytes),
