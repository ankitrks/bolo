...
urlpatterns = [
    ...
    url(r'^get_challenge/$', OldAlgoGetChallenge.as_view(), name='get_challenge'),
    url(r'^old_algo_get_challenge/$', GetChallenge, name='old_algo_get_challenge'),
    url(r'^get_popular_hash_tag/$', OldAlgoGetPopularHashTag.as_view(), name='get_popular_hash_tag'),
    url(r'^old_algo_get_popular_hash_tag/$', GetPopularHashTag.as_view(), name='old_algo_get_popular_hash_tag'),
    url(r'^get_follow_post/$', OldAlgoGetFollowPost.as_view(), name='get_follow_post'),
    url(r'^old_algo_get_follow_post/$', GetFollowPost, name='old_algo_get_follow_post'),
    ...
    url(r'^get_vb_list/$', OldAlgoVBList.as_view(), name='get_vb_list'),
    url(r'^old_algo_get_vb_list/$',VBList, name='old_algo_get_vb_list'),
    ...
    url(r'^get_category_detail_with_views/$', old_algo_get_category_detail_with_views),
    url(r'^old_algo_get_category_detail_with_views/$', get_category_detail_with_views),
    url(r'^get_category_video_bytes/$', old_algo_get_category_video_bytes),
    url(r'^old_algo_get_category_video_bytes/$',get_category_video_bytes),
    url(r'^get_popular_video_bytes/$',old_algo_get_popular_video_bytes ),
    url(r'^old_algo_get_popular_video_bytes/$', get_popular_video_bytes),
    url(r'^pubsub/popular/$', pubsub_popular),
    url(r'^get_user_follow_and_like_list/$', get_user_follow_and_like_list),
    url(r'^get_recent_videos/$',old_algo_get_recent_videos ),
    url(r'^old_algo_get_recent_videos/$',get_recent_videos ),

    url(r'^get_landing_page_video/$', get_landing_page_video),
    url(r'^get_popular_bolo/$', get_popular_bolo),
    
    url(r'^get_category_with_video_bytes/$', old_algo_get_category_with_video_bytes),
    url(r'^old_algo_get_category_with_video_bytes/$', get_category_with_video_bytes),
