...
function videoItemsTemplate(itemVideoByte,itemCount) {
    ...
    var popularHashTagTemplateItems ='<div class="column " style="cursor: pointer;">\
                            ...
                            <span onClick="openVideoInPopup(\''+itemVideoByte.question_video+'\',\''+itemVideoByte.question_image+'\','+itemCount+');" id="video_play_item_'+itemVideoByte.id+'" class="min-span-height">\
