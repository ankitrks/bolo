...
def run():
    ...
    for each_topic_id in actionable_ids:
        ...
        if opt_action =='comment':
            ...
            if each_topic.likes_count<random.randrange(900,1000) and each_topic.likes_count < each_topic.view_count:
    ...
    for each_like_id in last_n_days_post:
        ...
        if each_like.likes_count < random.randrange(900,1000):
