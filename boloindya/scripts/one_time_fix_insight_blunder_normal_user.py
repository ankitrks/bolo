...
def run():
    ...
    user_count = UserProfile.objects.filter(is_test_user = False, is_superstar = False, is_popular = False, is_business = False, is_insight_fix = False, user__date_joined__lte = till_date).count()
    for each_userprofile in UserProfile.objects.filter(is_test_user = False, is_superstar = False, is_popular = False, is_business = False, is_insight_fix = False, user__date_joined__lte = till_date).order_by('user__date_joined','-vb_count').values('user_id','user__username','user__date_joined'):
