...
def run():
    print "Start Time Eng_Engagment 16H: ",datetime.now()
    ...
    for each_like_id in last_n_days_post_ids:
        try:
            ...
            if each_like.likes_count < each_like.view_count/random.randrange(4,25):
                if each_like.date +timedelta(hours=16) < now and each_like.date +timedelta(hours=18) > now and each_like.view_count/random.randrange(10,21) > 1000 and each_like.likes_count < 1000:
    ...
    for each_seen_id in last_n_days_post_ids:
        try:
            ...
            if each_seen.date +timedelta(hours=16) < now and each_seen.date +timedelta(hours=18) > now and each_seen.view_count < 18000:
                print "topic_id: ",each_seen_id
            ...
            pass
    print "End Time Eng_Engagment 16H: ",datetime.now()
...
def check_like(topic_id,user_ids):
    ...
    if each_like.likes_count < each_like.view_count/random.randrange(4,25):
        if each_like.date +timedelta(hours=16) < now and each_like.date +timedelta(hours=18) > now and each_like.view_count/random.randrange(4,25) > 1000 and each_like.likes_count < 1000:
            number_like = random.randrange(1,1000-each_like.likes_count)
        else:
            number_like = 1
        i = 0
