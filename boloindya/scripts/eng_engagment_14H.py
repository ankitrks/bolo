...
def run():
    ...
    for each_like_id in last_n_days_post_ids:
        try:
            ...
            if each_like.likes_count < each_like.view_count/random.randrange(4,25):
                if each_like.date +timedelta(hours=14) < now and each_like.date +timedelta(hours=16) > now and each_like.view_count/random.randrange(4,25) > 900 and each_like.likes_count < 900:
    ...
    for each_seen_id in last_n_days_post_ids:
        try:
            ...
            if each_seen.date +timedelta(hours=14) < now and each_seen.date +timedelta(hours=16) > now and each_seen.view_count < 17000:
