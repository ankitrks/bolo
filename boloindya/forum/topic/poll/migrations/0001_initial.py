...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='TopicPoll',
            fields=[
                ('topic', models.OneToOneField(serialize=False, to='forum_topic.Topic', verbose_name='topic', primary_key=True, related_name='poll')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poll', models.ForeignKey(to='forum_topic_poll.TopicPoll', verbose_name='poll', related_name='choices')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateTimeField(default=django.utils.timezone.now)),
                ('choice', models.ForeignKey(to='forum_topic_poll.TopicPollChoice', verbose_name='poll choice', related_name='votes')),
