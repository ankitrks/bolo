...
class Notification(UserInfo):
    ...
    def get_notification_json(self):
        ...
        #     notific['actor_profile_pic'] = ""
            ...
            notific['hindi_title'] = '%s ने आपका सत्र %s बुक किया है'%(name, title)
            ...
            notific['bhojpuri_title'] = '%s ने आपका सत्र %s बुक किया है'%(name, title)
            notific['haryanvi_title'] = '%s ने आपका सत्र %s बुक किया है'%(name, title)
