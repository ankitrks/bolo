...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('forum_comment', '0002_auto_20150828_2003'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.ForeignKey(to='forum_comment.Comment', related_name='comment_polls')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_removed', models.BooleanField(default=False)),
                ('poll', models.ForeignKey(to='forum_comment_poll.CommentPoll', related_name='poll_choices')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_removed', models.BooleanField(default=False)),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('choice', models.ForeignKey(to='forum_comment_poll.CommentPollChoice', related_name='choice_votes')),
