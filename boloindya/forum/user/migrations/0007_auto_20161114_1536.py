...
def user_model_checker(apps, schema_editor):
    ...
    if user._meta.db_table == 'forum_user_user':
        raise Exception(
            '`forum_user.User` was deprecated on '
            ...
            '* Run `python manage.py migrate --fake forum_user 0007_auto_20161114_1536` '
            'this will skip this exception you are reading now.\n'
            '* Run `python manage.py migrate --fake forum_user 0008_auto_20161114_1707` '
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('forum_user', '0006_auto_20160606_0607'),
    ]
