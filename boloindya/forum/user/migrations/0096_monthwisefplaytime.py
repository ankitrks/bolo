# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2020-07-31 18:41
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('forum_user', '0095_merge_20200728_0131'),
    ]

    operations = [
        migrations.CreateModel(
            name='MonthWiseFplaytime',
            fields=[
                ...
                ('fplaytime', models.PositiveIntegerField(blank=True, db_index=True, default=0, null=True)),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_monthwise_fplaytime', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
